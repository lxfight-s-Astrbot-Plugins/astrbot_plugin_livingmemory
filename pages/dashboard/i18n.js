...
(() => {
  ...
  const MSG = {
    ...
    "common.retry":       { zh: "重试", en: "Retry", ru: "Повторить" },
    "table.openMemory":   { zh: "查看记忆 {0}", en: "Open memory {0}", ru: "Открыть память {0}" },
    "recall.searching":   { zh: "正在检索记忆…", en: "Searching memories…", ru: "Поиск воспоминаний…" },
    ...
    /* ---- Appearance ---- */
    "header.theme": {"zh": "外观与主题", "en": "Appearance", "ru": "Оформление"},
    "appearance.hint": {"zh": "选择即刻生效；偏好保存在当前浏览器。", "en": "Changes apply immediately and are saved in this browser.", "ru": "Изменения применяются сразу и сохраняются в этом браузере."},
    "appearance.style": {"zh": "视觉风格", "en": "Visual style", "ru": "Визуальный стиль"},
    "appearance.mode": {"zh": "明暗模式", "en": "Color mode", "ru": "Цветовой режим"},
    "appearance.system": {"zh": "自动", "en": "Auto", "ru": "Авто"},
    "appearance.light": {"zh": "浅色", "en": "Light", "ru": "Светлый"},
    "appearance.dark": {"zh": "深色", "en": "Dark", "ru": "Тёмный"},
    "appearance.systemHint": {"zh": "自动模式跟随 AstrBot；独立打开时跟随设备。", "en": "Auto follows AstrBot, or your device when opened independently.", "ru": "Авто следует теме AstrBot, а при отдельном открытии — теме устройства."},
    "appearance.editorial": {"zh": "Editorial · 原野", "en": "Editorial", "ru": "Editorial"},
    "appearance.editorialDesc": {"zh": "经典网格 · 醒目标题 · 利落线条", "en": "Classic grid, bold headlines, crisp lines", "ru": "Классическая сетка, крупные заголовки, чёткие линии"},
    "appearance.studio": {"zh": "Studio · 轻盈", "en": "Studio", "ru": "Studio"},
    "appearance.studioDesc": {"zh": "柔和圆角 · 蓝紫色调 · 悬浮卡片", "en": "Soft corners, indigo accents, floating cards", "ru": "Скругления, индиго, парящие карточки"},
    "appearance.paper": {"zh": "Paper · 书页", "en": "Paper", "ru": "Paper"},
    "appearance.paperDesc": {"zh": "暖纸色调 · 衬线标题 · 阅读留白", "en": "Warm paper, serif headings, room to read", "ru": "Тёплая бумага, заголовки с засечками, простор"},
    "appearance.terminal": {"zh": "Terminal · 终端", "en": "Terminal", "ru": "Terminal"},
    "appearance.terminalDesc": {"zh": "等宽字体 · 硬朗边框 · 仪表布局", "en": "Monospace type, sharp borders, instrument panels", "ru": "Моноширинный шрифт, строгие рамки, приборные панели"},

    /* ---- Workflow feedback ---- */
    "flow.resetFilters": {"zh": "重置筛选", "en": "Reset filters", "ru": "Сбросить фильтры"},
    "flow.status": {"zh": "状态", "en": "Status", "ru": "Статус"},
    "flow.type": {"zh": "类型", "en": "Type", "ru": "Тип"},
    "flow.sort": {"zh": "排序", "en": "Sort order", "ru": "Сортировка"},
    "flow.transfer": {"zh": "导入与导出", "en": "Import and export", "ru": "Импорт и экспорт"},
    "flow.exportAll": {"zh": "导出全部记忆，不受上方筛选条件限制。", "en": "Exports all memories, regardless of the filters above.", "ru": "Экспорт всех записей независимо от фильтров выше."},
    "flow.exportSelected": {"zh": "仅导出当前选中的 {0} 条记忆。", "en": "Exports only the {0} selected memories.", "ru": "Экспорт только выбранных записей: {0}."},
    "flow.importSteps": {"zh": "选择文件 → 检查预览 → 确认导入", "en": "Choose a file → Review preview → Confirm import", "ru": "Выберите файл → Проверьте → Подтвердите импорт"},
    "flow.selectedOnPage": {"zh": "本页已选 {0} 条", "en": "{0} selected on this page", "ru": "Выбрано на этой странице: {0}"},
    "flow.clearSelection": {"zh": "取消选择", "en": "Clear selection", "ru": "Снять выделение"},
    "flow.exporting": {"zh": "正在生成导出文件…", "en": "Preparing export…", "ru": "Подготовка экспорта…"},
    "flow.importReading": {"zh": "正在读取 {0}…", "en": "Reading {0}…", "ru": "Чтение {0}…"},
    "flow.importPreviewing": {"zh": "正在预检 {0}…", "en": "Validating {0}…", "ru": "Проверка {0}…"},
    "flow.importReview": {"zh": "请检查 {0} 的预览并确认导入。", "en": "Review the preview for {0} and confirm the import.", "ru": "Проверьте результат для {0} и подтвердите импорт."},
    "flow.importing": {"zh": "正在导入 {0}，请稍候…", "en": "Importing {0}, please wait…", "ru": "Импорт {0}, подождите…"},
    "flow.importCancelled": {"zh": "已取消导入，未写入记忆。", "en": "Import cancelled. No memories were written.", "ru": "Импорт отменён. Записи не добавлены."},
    "flow.nothingToImport": {"zh": "没有可导入的记忆：无效 {0} 条，重复 {1} 条。", "en": "Nothing to import: {0} invalid, {1} duplicates.", "ru": "Нечего импортировать: {0} некорректных, {1} дубликатов."},
    "flow.unsavedTitle": {"zh": "有未保存的修改", "en": "Unsaved changes", "ru": "Несохранённые изменения"},
    "flow.unsavedMessage": {"zh": "离开或替换内容会丢弃当前修改。是否放弃？", "en": "Leaving or replacing this content will discard your changes. Discard them?", "ru": "Выход или замена содержимого удалит ваши изменения. Отменить их?"},
    "flow.keepEditing": {"zh": "继续编辑", "en": "Keep editing", "ru": "Продолжить редактирование"},
    "flow.discard": {"zh": "放弃修改", "en": "Discard changes", "ru": "Отменить изменения"},
    "flow.waitForSave": {"zh": "正在处理，请完成后再离开。", "en": "An operation is in progress. Please wait before leaving.", "ru": "Операция выполняется. Дождитесь завершения перед выходом."},
    "flow.working": {"zh": "正在处理，请稍候…", "en": "Working, please wait…", "ru": "Выполняется, подождите…"},
    "flow.recallShortcut": {"zh": "输入查询并设置范围，再执行召回。快捷键：Ctrl / Cmd + Enter。", "en": "Enter a query and set its scope, then run recall. Shortcut: Ctrl / Cmd + Enter.", "ru": "Введите запрос и задайте область, затем запустите поиск. Ctrl / Cmd + Enter."},
    ...
    "prompt.reset":         { zh: "载入默认内容", en: "Load default content", ru: "Загрузить по умолчанию" },
