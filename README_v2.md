...
详见 [CHANGELOG.md](CHANGELOG.md) 和 [REFACTOR_SUMMARY.md](REFACTOR_SUMMARY.md)
...
├── main.py                          # 插件注册和生命周期管理 (300行)
├── core/
│   ├── exceptions.py                # 自定义异常定义 (61行)
│   ├── config_manager.py            # 配置管理器 (111行)
│   ├── plugin_initializer.py       # 插件初始化器 (408行)
│   ├── event_handler.py            # 事件处理器 (607行)
│   ├── command_handler.py          # 命令处理器 (265行)
...
- [功能分析文档](REFACTOR_FEATURE_ANALYSIS.md): 详细的功能清单
- [重构计划文档](REFACTOR_PLAN.md): 完整的重构计划
- [重构总结文档](REFACTOR_SUMMARY.md): 重构成果总结
